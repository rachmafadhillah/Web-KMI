      ...
      <div class="container">
        <div class="row">
          ...
          @foreach ($customer as $customer)
              ...
              <div
                class="single-logo hover:opacity-100 wow fadeIn flex items-center justify-center"
            ...
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-10 text-center section-title">
                        ...
                        <h3 class="title">Kabinet #SpiritKebaikan, <span> kabinet Badan Pengurus Harian Keluarga Muslim
                          Itenas (BPH KMI) Periode 23/24 yang terdiri dari 7 sektor dan 15 departemen.</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="justify-center row ">
            ...
            >
              ...
              <table>
                  <tr>
                      ...
                      <td>Membentuk muslim yang berakidah kuat serta taat beribadah</td>
                  </tr>
                  <tr>
                      <td style="vertical-align: top;">2. </td>
                      <td>Membentuk masyarakat kampus yang berukhuwah Islamiyah dengan mengesampingkan fanatisme golongan dan menjadikan Islam sebagai rahmat bagi semesta alam.</td>
                  </tr>
                  <tr>
                      <td style="vertical-align: top;">3. </td>
                      <td>Mengajak kepada kebaikan, menyuruh pada yang ma’ruf dan mencegah dari yang munkar dengan hikmah dan nasihat yang baik serta bertukar pikiran dengan cara yang baik.</td>
                  </tr>
                  <tr>
                      <td style="vertical-align: top;">4. </td>
                      <td>Mengembangkan kemampuan sumber daya manusia dalam mengelola ilmu pengetahuan dan teknologi.</td>
                  </tr>
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2">
                  ...
                  >
                    ...
                    <ul class="link">
                      ...
                      <li><a href="blog">Jurnal KMI</a></li>
                      <li><a href="portfolio">Portfolio</a></li>
                      <li><a href="profile">Annual Report</a></li>
