<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('departemen.index') }}" :active="request()->routeIs('departemen')">
                        {{ __('Departemen') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('customer.index') }}" :active="request()->routeIs('customer')">
                        {{ __('Logo') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('about.index') }}" :active="request()->routeIs('about')">
                        {{ __('Visi Misi') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('misi.index') }}" :active="request()->routeIs('profile')">
                        {{ __('Profile') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('home.index') }}" :active="request()->routeIs('home')">
                {{ __('Home') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('blog.index') }}" :active="request()->routeIs('blog')">
                {{ __('Blog') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('gallery.index') }}" :active="request()->routeIs('gallery')">
                {{ __('Gallery') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('portfolio.index') }}" :active="request()->routeIs('portfolio')">
                {{ __('Portfolio') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('misi.index') }}" :active="request()->routeIs('misi')">
                {{ __('Profile') }}
            </x-jet-responsive-nav-link>
        </div>
