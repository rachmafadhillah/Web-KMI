...
// departemen
Route::middleware(['auth:sanctum', 'verified'])->resource('/dashboard/departemen', DepartemenController::class);
Route::middleware(['auth:sanctum', 'verified'])->get('dashboard/departemen/destroy/{id}', 'App\Http\Controllers\DepartemenController@destroy');
Route::middleware(['auth:sanctum', 'verified'])->get('dashboard/departemen/ubah/{id}', 'App\Http\Controllers\DepartemenController@ubah');
//gallery
...
Route::get('departemen', 'App\Http\Controllers\DepartemenController@index_fr');
